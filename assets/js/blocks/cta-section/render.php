...
$overlay   = (int) ($attributes['overlayOpacity'] ?? 55);
$overlay   = max(0, min(100, $overlay));
$alpha     = $overlay / 100;
?>
<section <?php echo get_block_wrapper_attributes(['class' => 'section greensun-cta-section']); ?> style="position:relative; overflow:hidden;">
  <?php if ($image_url) : ?>
