    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'label'         => 'Layout options (text — legacy)',
                'name'          => 'venue_layouts',
                'type'          => 'text',
                'placeholder'   => 'e.g. Banquet · Theater · Classroom',
                'instructions'  => 'Comma-separated list, used only when the “Capacity by layout” table below is empty.',
            ],
            [
                'key'           => 'field_venue_capacity_layouts',
                'label'         => 'Capacity by layout',
                'name'          => 'venue_capacity_layouts',
                'type'          => 'repeater',
                'instructions'  => 'One row per room configuration — drives the capacity-by-layout table (each layout shows a diagram glyph + its max guests).',
                'layout'        => 'table',
                'button_label'  => 'Add layout',
                'sub_fields'    => [
                    [
                        'key'           => 'field_venue_cl_layout',
                        'label'         => 'Layout',
                        'name'          => 'layout',
                        'type'          => 'select',
                        'choices'       => [
